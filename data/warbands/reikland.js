/* Reikland Mercenaries (grade core). Source: Mordheim core rulebook. See data/README.md for the fields. */
registerWarband("reikland", {
  "name": "Reikland Mercenaries",
  "source": "Mordheim core rulebook",
  "tags": ["human","mercenary","good","reikland"],
  ...
  "units": [
    ...
    {"id":"champion","n":"Champion","race":"human","stats":{"M":4,"WS":4,"BS":3,"S":3,"T":3,"W":1,"I":3,"A":1,"Ld":7},"kind":"hero","c":35,"max":2,"startXp":8,"skills":["combat","shooting","strength"]},
    ...
    {"id":"marksman","n":"Marksman","race":"human","stats":{"M":4,"WS":3,"BS":4,"S":3,"T":3,"W":1,"I":3,"A":1,"Ld":7},"kind":"henchman","c":25,"max":7,"gear":["Mace","Hammer","Axe","Sword","Crossbow","Pistol","Bow","Long bow","Blunderbuss","Handgun","Hunting Rifle","Light armour","Shield","Helmet"],"note":"Reikland marksmen have +1 BS (included in the profile)."},
