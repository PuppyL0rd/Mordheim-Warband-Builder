/* Marauders of Chaos: Hung (grade 1c). Source: Border Town Burning (grade 1c). See data/README.md for the fields. */
registerWarband("maraudershung", {
  "name": "Marauders of Chaos: Hung",
  ...
  "maxModels": 12,
  "maxHeroes": 6,
  "gear": ["Hammer","Axe","Sword","Halberd","Morning star","Double-handed weapon","Flail","Barbed Whip","Great Axe","Spear","Throwing knives","Shield","Helmet","Light armour","Heavy armour","Warhorse"],
  "opts": {
